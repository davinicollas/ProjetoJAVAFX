...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		tableColumnBirthDate.setCellValueFactory(new PropertyValueFactory<>("birgthDate"));
	...
	private void createDialogForm(Seller obj, String absuluteName, Stage parentStage) {
		/*try {
			...
			controller.setdepartamentService(new SellerServices());
